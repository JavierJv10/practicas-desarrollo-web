...
| :--- | :--- | :--- |
| **[Gestor de Eventos]([ruta-a-la-carpeta](https://github.com/JavierJv10/practicas-desarrollo-web/tree/main/gestor-eventos))** | App interactiva con manipulación de DOM en tiempo real. | JS, HTML, CSS |
